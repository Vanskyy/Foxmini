...
public class Experiment {
    ...
    private List<ExperimentStage> stages = new ArrayList<>();

    @OneToMany(mappedBy = "experiment", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<ExperimentResource> resources = new ArrayList<>();
    ...
    public List<ExperimentStage> getStages() {
        return stages;
    }

    public void setStages(List<ExperimentStage> stages) {
        this.stages = stages;
    }

    public List<ExperimentResource> getResources() {
        return resources;
    }

    public void setResources(List<ExperimentResource> resources) {
